...
<head>
    ...
    <script src="/projectC/wishlist.js"></script>
    <style>
      body {
...
@media (max-width: 480px) {
    .search-bar button {
        font-size: 12px; /* Adjust button text size for very small screens */
    }
}
    ...
    <header>
        <div class="header-section">
            <div class="logo-container">
                <div class="logo">
                    <img src="/projectC/image/logo.jpg" alt="E-Pharmacy Logo">
                </div>
            ...
            <div class="header-right">
                ...
                <a href="/projectC/wishlist_page.php" class="wishlist-link">
                <span class="material-icons">favorite</span>
                </a>

                <a href="/projectC/cart.php" class="cart-container">
               ...
               <a href="/projectC/my_order.php" class="order-link">
    ...
    <div class="navbar-section">
        <nav>
            <ul>
                ...
                <li><a href="/projectC/aboutUs.php">About</a></li>
                <li><a href="/projectC/contactUs.php">Contact Us</a></li>
                
                <li class="dropdown">
                    <a href="#categories">Categories ▾</a>
                    <div class="dropdown-content">
                        <a href="/projectC/medicine/mainmedicine.php">Medicine</a>
                        <a href="/projectC/maindailycare.php">Daily Care</a>
                        <a href="/projectC/mother-care.php">Mother & Baby Care</a>
                        <a href="/projectC/ayurveda.php">Ayurveda</a>
                        <a href="/projectC/dpc.php">Personal Care</a>
                    </div>
                </li>
            </ul>
        </nav>
     ...
     <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <h2 style="color: #1996b2">Login</h2>
